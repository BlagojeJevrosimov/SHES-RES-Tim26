...
namespace SolarPanelTest
{
    ...
    public class CommonDTOSolarPanelTest
    {
        int time;
        DateTime timeAsDT;
        Mock<Common.DTO.SolarPanelsDTO> mockB;

        [SetUp]
        public void Setup()
        {
            mockB = new Mock<Common.DTO.SolarPanelsDTO>();
        ...
        {
            Common.DTO.SolarPanelsDTO dtoB = new Common.DTO.SolarPanelsDTO(power, time);
